      ...
      <HStack>
        <Container align={'end'}>
          <VStack >
            ...
            Aspiring Software Engineer / Junior Game Developer
          </Text>
          </VStack>
        </Container>
        <Container >
          ...
          <Text fontSize={'md'}  p={2}>
            After decades of being around computers for leisure and hobby, I have decided to turn my interests towards a career path.
          </Text>
          <Text fontSize={'md'}  p={2}>
            I have always enjoyed taking on difficult tasks and working with others. In this sense, the field offers a lot of personal enjoyment and opportunities ot add value to others around me.
          </Text>
          <Text fontSize={'md'}  p={2}>
